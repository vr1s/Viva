...
#include "VIVAResources.h"

@implementation VIVAResources

+ (UIImage *)logo
{
    NSBundle *bundle = [NSBundle bundleWithPath:@"/Library/Application Support/Viva.bundle"];
    NSString *imagePath = [bundle pathForResource:[NSString stringWithFormat:@"assets/icons/%@", @"viva"] ofType:@"png"];
