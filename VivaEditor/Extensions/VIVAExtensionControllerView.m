...
@implementation VIVAExtensionControllerView
...
- (void)topSliderUpdated:(UISlider *)sender
{
    ...
    [VIVAUtility writeToBundle:self.bundleID atKey:self.topPreferenceLink withValue:[NSNumber numberWithFloat:sender.value]];
...
{
    [VIVAUtility writeToBundle:self.bundleID atKey:self.bottomPreferenceLink withValue:[NSNumber numberWithFloat:sender.value]];
