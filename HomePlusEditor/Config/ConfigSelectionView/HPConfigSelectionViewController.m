...
#import "HPConfigSelectionViewController.h"
...
@implementation HPConfigSelectionViewController
{
...
{
    return [[HPConfigurationManager.sharedInstance.directory.configurations allKeys] count];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *name = ([HPConfigurationManager.sharedInstance.directory.configurations allKeys][(NSUInteger) indexPath.row]);
    [HPConfigurationManager.sharedInstance setCurrentConfiguration:[HPConfigurationManager.sharedInstance configurationWithName:name createIfNecessary:NO]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell) {
        ...
        if (name == [HPConfigurationManager.sharedInstance.currentConfiguration name]) {
            cell.accessoryType = UITableViewCellAccessoryCheckmark;
        } else {
